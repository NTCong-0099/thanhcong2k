...
if ( ! nv_function_exists( 'nv_archives_category' ) )
{
    ...
    function nv_archives_category ( $block_config )
    {
        ...
        $xtpl = new XTemplate( "block_category.tpl", NV_ROOTDIR . "/themes/" . $block_theme . "/modules/archives" );
...
if ( defined( 'NV_SYSTEM' ) )
{
    ...
    if ( isset( $site_mods[$module] ) )
    {
        ...
        else
        {
            ...
            $sql = "SELECT * FROM `" . NV_PREFIXLANG . "_" . $site_mods[$module]['module_data'] . "_cat` ORDER BY `order` ASC";
