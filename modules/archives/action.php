...
$sql_drop_module[] = "DROP TABLE IF EXISTS `" . NV_PREFIXLANG . "_" . $module_data . "_room`;";
$sql_drop_module[] = "DROP TABLE IF EXISTS `" . NV_PREFIXLANG . "_" . $module_data . "_field`;";
$sql_drop_module[] = "DROP TABLE IF EXISTS `" . NV_PREFIXLANG . "_" . $module_data . "_organ`;";
...
$sql_create_module[] = "CREATE TABLE `" . NV_PREFIXLANG . "_" . $module_data  . "_room` (
...
$sql_create_module[] = "CREATE TABLE `" . NV_PREFIXLANG . "_" . $module_data  . "_field` (
...
$sql_create_module[] = "CREATE TABLE `" . NV_PREFIXLANG . "_" . $module_data  . "_organ` (
